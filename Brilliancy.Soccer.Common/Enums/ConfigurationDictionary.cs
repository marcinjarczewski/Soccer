namespace Brilliancy.Soccer.Common.Enums
{
    ...
    {
        public static string FtpUploadRoot = "FtpUploadRoot";

        public static string FtpDownloadRoot = "FtpDownloadRoot";

        public static string FtpFileSubfolder = "FtpFileSubfolder";

        public static string FtpPhotoSubfolder = "FtpPhotoSubfolder";
